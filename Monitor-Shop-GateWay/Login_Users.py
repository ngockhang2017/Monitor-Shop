...
def register_user(form : RegisForm):
    url = f"{SERVICE_URL}/api/customers/register"
...
@router.get("/getAll/")
def get_all_user():
    url = f"{SERVICE_URL}/api/customers/getAll"
...
def get_by_user_id(id : int):
    url = f"{SERVICE_URL}/api/customers/get-by-id/"
...
def edit_customer(form : UserForm):
    url = f"{SERVICE_URL}/api/customers/edit/"
...
def edit_customer(form : Profile):
    url = f"{SERVICE_URL}/api/customers/edit-password/"
